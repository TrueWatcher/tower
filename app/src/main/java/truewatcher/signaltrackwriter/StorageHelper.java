...
public class StorageHelper {
  ...
  private void checkWithListSize(int expected, PointList pl) throws U.DataException {
  ...
  // ^ copied intact from truewatcer.tower
  //---------------------------------------------------------------
  // adaptation
  ...
  private class GpxHelper {

    public String gpx2csv(String buf) {
      Log.e(U.TAG, "GpxHelper:"+"not really implemented");
      throw new U.RunException("GpxHelper:"+"not really implemented");
    }

    public String csv2gpx(String buf) {
      Log.e(U.TAG, "GpxHelper:"+"not really implemented");
      throw new U.RunException("GpxHelper:"+"not really implemented");
    }
